"""drop horoscope_readings: horoscope feature removed

Revision ID: 0022_drop_horoscope_readings
Revises: 0021_horoscope_readings
...
revision: str = "0022_drop_horoscope_readings"
down_revision: str | None = "0021_horoscope_readings"
